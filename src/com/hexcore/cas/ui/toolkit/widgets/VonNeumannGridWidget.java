...
public class VonNeumannGridWidget extends Grid2DWidget
{
	public VonNeumannGridWidget(VonNeumannGrid grid, int cellSize)
	{
		this(new Vector2i(0, 0), grid, cellSize);
	}

	public VonNeumannGridWidget(Vector2i position, VonNeumannGrid grid, int cellSize)
	{
