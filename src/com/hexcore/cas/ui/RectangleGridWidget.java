...
public class RectangleGridWidget extends GridWidget
{
	...
	{
		super(new Vector2i(grid.getWidth() * tileSize, grid.getHeight() * tileSize));
		this.grid = grid;
		this.tileSize = tileSize;
	}
	
	public void setGrid(RectangleGrid grid)
	{
		this.grid = grid;
	}
