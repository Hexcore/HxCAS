...
public class TestHexagonGrid extends TestCase
{
	public void testGetNeighboursFunction()
	{
		...
		assertEquals(21.0, 	grid.getCell(1, 0).getValue(0));
		assertEquals(27.0, 	grid.getCell(2, 0).getValue(0));
		
		assertEquals(18.0, 	grid.getCell(0, 1).getValue(0));
		assertEquals(30.0, 	grid.getCell(1, 1).getValue(0));
		assertEquals(18.0, 	grid.getCell(2, 1).getValue(0));
		
		assertEquals(27.0, 	grid.getCell(0, 2).getValue(0));
		assertEquals(21.0, 	grid.getCell(1, 2).getValue(0));
		assertEquals(27.0, 	grid.getCell(2, 2).getValue(0));
		
		//not wrap-around
		grid = addNeighbours(3,3, false);
		assertEquals(4.0, 	grid.getCell(0, 0).getValue(0));
		assertEquals(14.0, 	grid.getCell(1, 0).getValue(0));
		assertEquals(6.0, 	grid.getCell(2, 0).getValue(0));
		
		assertEquals(11.0, 	grid.getCell(0, 1).getValue(0));
		assertEquals(30.0, 	grid.getCell(1, 1).getValue(0));
		assertEquals(15.0, 	grid.getCell(2, 1).getValue(0));
		
		assertEquals(14.0, 	grid.getCell(0, 2).getValue(0));
		assertEquals(18.0, 	grid.getCell(1, 2).getValue(0));
		assertEquals(16.0, 	grid.getCell(2, 2).getValue(0));
	}
